...
class Loader:
    ...
    def _loader(self):
        if self.dataset == 'sysu':
            ...
            self.normal_samples_with_shape = normal_samples_with_shape
    ...
    def get_train_normal_with_shape_loader(self):
        ...
        self.normal_samples_with_shape.cIndex = normal_sampler.index1
        self.normal_samples_with_shape.tIndex = normal_sampler.index2
        normal_train_loader_with_shape = data.DataLoader(self.normal_samples_with_shape, batch_size=self.stage1_batch_size,
                                       sampler=normal_sampler, num_workers=self.num_workers, drop_last=True)
        return normal_train_loader_with_shape
