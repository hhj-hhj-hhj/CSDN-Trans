...
from tools import os_walk, CrossEntropyLabelSmooth, SupConLoss, TripletLoss_WRT, hcc_euc, hcc_kl, hcc_kl_3, ptcc, ptcc_3, ContrastiveLoss
...
class Base:
    ...
    def _init_creiteron(self):
        ...
        self.modal_contrastive = ContrastiveLoss()
