...
from network.model_attention import Model
from network.lr import CosineLRScheduler
from tools import os_walk, CrossEntropyLabelSmooth, SupConLoss, TripletLoss_WRT, hcc_euc, hcc_kl, hcc_kl_3, center_ce, ptcc, ptcc_3
...
class Base:
    ...
    def _init_creiteron(self):
        ...
        self.criterion_center_ce = center_ce()
