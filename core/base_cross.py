...
from tools import os_walk, CrossEntropyLabelSmooth, SupConLoss, TripletLoss_WRT, MSEL, MSEL_Feat, MSEL_Cos, IPD, IPC_v2,IPD_rgb, IPC_v2_rgb, IPD_rgb_ir, IPC_v2_rgb_ir
...
class Base:
    ...
    def _init_creiteron(self):
        ...
        # self.IPC_1 = IPC_v2_rgb_ir(margin=0.6)
        self.IPC_1 = IPC_v2_rgb(margin=0.6)
        # self.IPD_1 = IPD_rgb_ir(margin=0.3)
        self.IPD_1 = IPD_rgb(margin=0.3)
