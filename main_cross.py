...
def main(config):
    ...
    if config.mode == 'train':
        ...
        # logger('save the mode of the 1st stage, batchsize=128')
        # model_file_path = os.path.join(model.save_model_path, 'end_sysu/model_stage1_batchsize128.pth')
        ...
        logger('Load the 1st Stage Model End')
