...
def main(config):
    ...
    if config.mode == 'train':
        ...
        #
        # visible_image_features = [[] for i in range(config.num_classes)]
        # infrared_image_features = [[] for i in range(config.num_classes)]
        # visible_len = []
        # infrared_len = []
        # visible_mean = []
        # infrared_mean = []
...
# --------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        modelPath = os.path.join(testModelPath, 'model_no_attention_kl3+kl3map.pth')
