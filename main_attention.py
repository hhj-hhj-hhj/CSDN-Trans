...
def main(config):
    ...
    if config.mode == 'train':
        ...
        #
        #
        print(f'Load the 0 Stage Model')
...
# --------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        testModelPath_attention = r'D:\PretrainModel\CSDN\models\base\models\backup_attention\model_0.pth'

        model.model.load_state_dict(torch.load(testModelPath_attention))
